    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[82%_50%] opacity-35 mix-blend-screen md:opacity-90"
        />
      </div>
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,#020303_0%,rgba(2,3,3,0.98)_28%,rgba(2,3,3,0.76)_47%,rgba(2,3,3,0.12)_67%,rgba(2,3,3,0.34)_100%)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.34)_0%,rgba(0,0,0,0.03)_32%,rgba(0,0,0,0.12)_68%,rgba(0,0,0,0.62)_100%)]"
      />
      <div
        aria-hidden="true"
      ...
      >
        <span className="absolute right-[18.9vw] top-[21%]">01</span>
        <span className="absolute right-[11.2vw] top-[18.5%] text-[#d9b978]/80">A1</span>
        <span className="absolute right-[21.6vw] top-[58%] text-[#f3f4f1]/34">21</span>
        <ul className="absolute right-[14.3vw] top-[67%] space-y-2 text-left text-[#f3f4f1]/48">
      ...
      <div className="relative z-10 min-h-[calc(100svh-5.25rem)] px-4 py-16 sm:px-6 md:py-24 lg:px-[5.7vw] lg:py-[clamp(4.1rem,7.4vh,6rem)]">
        <div className="relative z-20 max-w-[49rem] min-w-0">
